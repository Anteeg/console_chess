...
public class Program {
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (!game.isFinished()) { //TODO move the while loop to an external method for functional decomposition eg (Separation of concern) or move to a new class MVC is wrong
